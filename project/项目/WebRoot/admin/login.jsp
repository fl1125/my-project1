        ...
        <div class="block">
            ...
            <div class="block-body">
                <form action="<%=path %>/admin/login.do" method="post">
                    <label>用户名</label>
                    <input type="text" name="username" class="span12" required oninvalid="setCustomValidity('用户名不能为空')" oninput="setCustomValidity('');">
                    <label>密码</label>
                    <input type="password" name="userpassword" class="span12" class="userpassword" required oninvalid="setCustomValidity('密码不能为空')" oninput="setCustomValidity('');">
                    <label></label>
