      ...
      <c:forEach items="${list}" var="member">
        ...
        <tr>
         <td style="font-weight: bold;font-family:楷体;font-weight: bold; color:blue;text-align: right;" colspan="9">
                                                                 共${total}条记录&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="<%=path %>/admin/searchMember.do?index=1&key=${key}" style="font-family:微软雅黑;">首页</a>&nbsp;&nbsp;
                        
                        <c:choose>
                        <c:when test="${index >1}">
                        <a href="<%=path %>/admin/searchMember.do?index=${index-1}&key=${key}" style="font-family:微软雅黑;">上一页</a>
                        </c:when>
                        <c:otherwise>
                        ...
                        <a href="<%=path %>/admin/searchMember.do?index=${index+1}&key=${key}" style="font-family:微软雅黑;">下一页</a>
                        </c:when>
                        <c:otherwise>
                        ...
                        &nbsp;&nbsp;
                        <a href="<%=path %>/admin/searchMember.do?index=${pages}&key=${key}" style="font-family:微软雅黑;">末页</a>
                    </td>
        </tr>
      </tbody>
    </table>
