...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="<%=path %>/admin/infosEdit.do" method="post">
		    <input type="hidden" name="id" value="${infos.id}"/>
		    <input type="hidden" name="type" value="${infos.type}"/>
		    
		        <label>标题</label>
		        <input type="text" id="title" name="title" class="input-xlarge span12"  value="${infos.title}" required>
		        <label>内容</label>
		        <textarea id="note" name="note" style="width:1000px;height:400px;" >${infos.note}</textarea>
