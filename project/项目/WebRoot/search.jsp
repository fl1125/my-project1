    ...
    <div class="layui-col-md8">
      <div class="fly-panel" style="margin-bottom: 0;">
		...
		<c:forEach items="${list}" var="tzinfo">
          <li>
            <a href="Home.do?memberid=${tzinfo.member.tname}" class="fly-avatar">
              <img src="<%=path %>/upload/${tzinfo.member.filename}" alt="${tzinfo.member.tname}">
            </a>
            <h2>
              <a class="layui-badge">${tzinfo.stype.typename}</a>
              <a href="tzDetail.jsp?id=${tzinfo.id}">${tzinfo.title}</a>
            </h2>
            <div class="fly-list-info">
              <a href="Home.do?memberid=${tzinfo.member.id}" link>
