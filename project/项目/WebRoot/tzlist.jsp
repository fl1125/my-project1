    ...
    <div class="layui-col-md8">
      <div class="fly-panel">
        ...
        <ul class="fly-list">
          ...
          <li>
            <a href="Home.do?memberid=${toptzinfo.member.id}" class="fly-avatar">
              <img src="<%=path %>/upload/${toptzinfo.member.filename}" alt="${toptzinfo.member.tname}">
            </a>
            <h2>
              <a class="layui-badge">${toptzinfo.stype.typename}</a>
              <a href="tzDetail.do?id=${toptzinfo.id}">${toptzinfo.title}</a>
            </h2>
            <div class="fly-list-info">
              <a href="Home.do?memberid=${toptzinfo.member.id }" link>
      ...
      <div class="fly-panel" style="margin-bottom: 0;">
        ...
        <div class="fly-panel-title fly-filter">
          <a href="tzList.do?fid=${fid}" >全部</a>
          <c:forEach items="${childlist}" var="stype">
          <span class="fly-mid"></span>
          <a href="tzList.do?fid=${fid}&sid=${stype.id}" class="layui-this">${stype.typename}</a>
          </c:forEach>
        </div>

        <ul class="fly-list">  
        
		<c:forEach items="${ptlist}" var="pttzinfo">      
          <li>
            <a href="Home.do?memberid=${pttzinfo.member.id}" class="fly-avatar">
              <img src="<%=path %>/upload/${pttzinfo.member.filename}" alt="${pttzinfo.member.tname}">
            </a>
            <h2>
              <a class="layui-badge">${pttzinfo.stype.typename }</a>
              <a href="tzDetail.do?id=${pttzinfo.id }">${pttzinfo.title }</a>
            </h2>
            <div class="fly-list-info">
              <a href="Home.do?memberid=${pttzinfo.member.id}" link>
        ...
        <div style="text-align: center">
	        <div >
	        	<div id="LAY_page">
	        	共${total}条记录&nbsp;&nbsp;&nbsp;&nbsp;
          <a href="tzList.do?index=1&fid=${fid}" style="font-family:微软雅黑;">首页</a>&nbsp;&nbsp;
          
          <c:choose>
          <c:when test="${index >1}">
          <a href="tzList.do?index=${index-1}&fid=${fid}" style="font-family:微软雅黑;">上一页</a>
          </c:when>
          <c:otherwise>
          ...
          <a href="tzList.do?index=${index+1}&fid=${fid}" style="font-family:微软雅黑;">下一页</a>
          </c:when>
          <c:otherwise>
          ...
          &nbsp;&nbsp;
          <a href="tzList.do?index=${pages}&fid=${fid}" style="font-family:微软雅黑;">末页</a>
