    ...
    <div class="layui-col-md8">
      <div class="fly-panel">
        ...
        <c:forEach items="${typelist}" var="ftype">
          <li>
            <a href="tzList.do?fid=${ftype.id }" class="fly-avatar">
              <img src="https://tva1.sinaimg.cn/crop.0.0.118.118.180/5db11ff4gw1e77d3nqrv8j203b03cweg.jpg" alt="贤心">
            </a>
            <h2>
              <a class="layui-badge">版块</a>
              <a href="tzList.do?fid=${ftype.id }">${ftype.typename}</a>
            </h2>
            <div class="fly-list-info">
              <a href="tzList.do?fid=${ftype.id }&sid=0" link>
              </a>
              
              <span>
              	版主:
               <c:if test="${ftype.banzhu ne null}">
               <a href="Home.do?memberid=${ftype.banzhu.id}">${ftype.banzhu.tname}</a>&nbsp;&nbsp;&nbsp;
               </c:if>
