      ...
      <div class="layui-tab layui-tab-brief" lay-filter="user">
        ...
        <div class="layui-form layui-tab-content" id="LAY_ucm" style="padding: 20px 0;">
          <div class="layui-tab-item layui-show">
            <form action="tzinfoEdit.do" method="post">
            <input type="hidden" name="id" value="${tzinfo.id}"/>
              ...
              <div class="layui-form-item layui-form-text">
                <div class="layui-input-block">
                  <textarea id="note" name="note"  class="layui-textarea "  style="height: 260px;" >${tzinfo.note }</textarea>
                </div>
              </div>
				<c:choose>
				  <c:when test="${member.isjy eq 'no'}">
				   <div class="layui-form-item">
	                <button class="layui-btn" >立即提立</button>
	              </div>
				  </c:when>
				  <c:otherwise>
				  <div class="layui-form-item">
