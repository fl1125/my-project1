	  ...
	  <div class="fly-panel fly-panel-user" pad20>
	    ...
	    <div class="layui-tab layui-tab-brief" lay-filter="user">
	      <ul class="layui-tab-title" id="LAY_mine">
	        ...
	        <li><a href="myrecSx.do">接收</a></li>
	      </ul>
	      <div class="layui-tab-content" style="padding: 20px 0;">
	        <div class="layui-tab-item layui-show">
	          <ul class="mine-view jie-row">
	          <c:forEach items="${list}" var="sxinfo">
	            <li>
	              <a class="jie-title">(${sxinfo.sxmember.tname })&nbsp;&nbsp;私信内容:${sxinfo.note}</a>
	              <a class="jie-title" href="Home.do?memberid=${sxinfo.sxmemberid}" target="_blank">回复内容:${sxinfo.hfnote}</a>
	              <i>日期:${sxinfo.savetime}&nbsp;&nbsp;&nbsp;&nbsp;</i>
	              <a class="mine-edit" href="sxDel.do?id=${sxinfo.id}&type=send">删除</a>
	            </li>
	          </c:forEach>
	          </ul>
	          <div id="LAY_page">
	            ...
	            <li style="color: #009688">
                                                                 共${total}条记录&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="<%=path %>/admin/mysendSx.do?index=1" style="font-family:微软雅黑;color:#009688;font-weight: bold;">首页</a>&nbsp;&nbsp;
                        
                        <c:choose>
                        <c:when test="${index >1}">
                        <a href="<%=path %>/admin/mysendSx.do?index=${index-1}" style="font-family:微软雅黑;color:#009688;font-weight: bold;">上一页</a>
                        </c:when>
                        <c:otherwise>
                        ...
                        <a href="<%=path %>/admin/mysendSx.do?index=${index+1}" style="font-family:微软雅黑;color:#009688;font-weight: bold;">下一页</a>
                        </c:when>
                        <c:otherwise>
                        ...
                        &nbsp;&nbsp;
                        <a href="<%=path %>/admin/mysendSx.do?index=${pages}" style="font-family:微软雅黑;color:#009688;font-weight: bold;">末页</a>
	            </li>
	          </ul>
