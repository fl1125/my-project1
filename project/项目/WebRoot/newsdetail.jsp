    ...
    <div class="layui-col-md8 content detail">
      <div class="fly-panel detail-box">
        ...
        <c:if test="${news.filename ne ''}">
          ...
          ${news.content }
          <!--  
          <embed src="http://localhost:8088/gymshoesbbs/kindeditor/plugins/ckplayer/ckplayer.swf" flashvars="video=/gymshoesbbs/attached/media/20180320/20180320174122_252.mp4" type="application/x-shockwave-flash" width="550" height="400" autostart="false" loop="true" />
-->
        </div>
      </div>
