	  ...
	  <div class="fly-panel fly-panel-user" pad20>
	    ...
	    <div class="layui-tab layui-tab-brief" lay-filter="user">
	      <ul class="layui-tab-title" id="LAY_mine">
	      	...
	      	<li ><a href="memberCenter.do">我发的帖（<span>${fn:length(publishlist) }</span>）</a></li>
	      	<li data-type="mine-jie" lay-id="index" class="layui-this">我回复的帖（<span>${fn:length(list)}</span>）</li>
	      </ul>
	      <div class="layui-tab-content" style="padding: 20px 0;">
	        <div class="layui-tab-item layui-show">
	          <ul class="mine-view jie-row" >
	           <c:forEach items="${list}" var="tzhtinfo">
	            <li>
	              
		          <p><a class="layui-badge" href="tzList.do?fid=${tzhtinfo.ftype.id}">${tzhtinfo.ftype.typename}</a></p>  
	              <a class="jie-title" href="tzDetail.do?id=${tzhtinfo.tzinfo.id }" target="_blank">${tzhtinfo.tzinfo.title }</a>
